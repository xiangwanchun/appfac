...
let MenuVideolist = React.createClass({
  getInitialState() {
    return {
       titleNum:'0',
   	   title2Num : '0',
							...
							<Col span='15'>
								<FormItem
								          ...
								          labelCol={{ span: 4 }}
		      							  wrapperCol = {{ span: 18 }}
											>
											<span className='Category wrapperColheight'>{videolist}</span>
								</FormItem>	
							</Col>
						</div>
						<div className='MenuFormColCont'>
...
MenuVideolist = createForm()(MenuVideolist);
export default  MenuVideolist;
