...
let MenuOutside= React.createClass({
  getInitialState() {
    return {
       titleNum:'0',
   	   title2Num : '0',
				...
				<div className='MenuFormCont'>
					<div className='MenuFormCol'>
						...
						<div className='MenuFormColCont'>
							<Row>
								<Col span='6'>
								        <div className="inputNumWrap">
						                    <FormItem
						                      id="control-inputnav2"
						                      label="二级页面名"
						                      labelCol={{ span:10 }}
						                      wrapperCol={{ span:12}}
						                      >    
						                      <Input id="control-inputnav2"  placeholder={this.props.data.sname} {...title2Props}/>
						                    </FormItem>
						...
						<div className='MenuFormColCont'>
							<Row>
								<Col span='6'>
								        <div className="inputNumWrap lininput">
						                    <FormItem
						                      id="control-inputlink"
						                      label="外链地址"
						                      labelCol={{ span:10 }}
						                      wrapperCol={{ span:12}}
						                      >    
						                      <Input id="control-inputlink"  placeholder={this.props.data.sname} {...linkProps}/>
						                    </FormItem>
						                </div>
							      </Col>  
							</Row>
...
MenuOutside = createForm()(MenuOutside);
